  ...
  <footer class="bg-neutral text-neutral-content">
    <div class="container px-6 py-8 mx-auto space-y-8 lg:space-y-0 lg:flex lg:justify-between">
      ...
      <div class="flex flex-col space-y-4">
        ...
        <a href="#" class="link-hover">Visit</a>
        <a href="#" class="link-hover">Exhibitions</a>
        <a href="#" class="link-hover">Programs & Events</a>
        <a href="#" class="link-hover">Store</a>
        <a href="#" class="link-hover">Membership</a>
      </div>

      <div>
        <p class="font-medium capitalize">Connect</p>

        <div class="flex mt-6 -mx-4">
          <a class="mx-4 link-hover" href="#">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
    ...
    <p class="w-full py-6 mx-auto text-neutral-content text-center bg-neutral-focus">
