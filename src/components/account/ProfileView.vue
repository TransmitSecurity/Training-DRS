  ...
  <div class="divide-y divide-base-200/50">
    <div class="py-6 px-4 sm:p-6 lg:pb-8">
      ...
      >
        ...
        <div class="col-span-12 md:col-span-6">
          <label for="birthday" class="label label-text">{{
            $t("userData.birthday")
          }}</label>
          <Datepicker
          ...
          <button
            ...
            :class="
              updatePersonalInformationLoading
                ? 'loading loading-spinner btn-disabled'
                : ''
            "
          >
    ...
    <div class="py-6 divide-y divide-base-200/50 gap-y-8">
      <div class="px-4 sm:px-6">
        ...
        <router-link
          ...
          >{{ $t("account.profile.editYourContactInformation") }}</router-link
        >
      </div>
    </div>
      ...
      <form class="px-4 sm:px-6" @submit.prevent="updatePostalAddress">
        ...
        <div class="flex justify-end">
          <button
            ...
            type="submit"
            :class="
              updateAddressLoading ? 'loading loading-spinner btn-disabled' : ''
            "
          >
    ...
    <div class="pt-6 divide-y divide-base-200/50">
      ...
      <div class="mt-4 py-4 px-4 flex justify-end sm:px-6">
        ...
        <button type="submit" class="btn btn-primary ml-5 btn-sm">
          {{ $t("global.save") }}
        </button>
      </div>
    </div>
