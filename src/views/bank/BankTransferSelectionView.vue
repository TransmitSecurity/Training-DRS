      ...
      >
        <div class="flex flex-col flex-1 px-10">
          <h2 class="font-bold text-3xl pb-4">
            {{ $t("bank.transfer.transferMoney") }}
          </h2>
          <div class="mt-8">
            <h3 class="font-medium mb-2">
              {{ $t("bank.transfer.accountToDebit") }}
            </h3>
            <account-selection
              id="accountSelection"
          ...
          <div class="mt-12">
            <div class="flex justify-between">
              ...
              <div class="link flex items-center text-primary gap-x-2">
                <plus-circle-icon class="w-8 h-8" />
                {{ $t("bank.addABeneficiary") }}
              </div>
            </div>
          ...
          >
            ...
            <button
              id="validateForm"
              class="btn btn-primary md:col-span-2 mt-8"
              type="submit"
            >
              {{ $t("global.next") }}
            </button>
          ...
          <div class="absolute flex w-full flex-col top-0">
            <div class="flex flex-col items-center mt-4">
              <div class="card bg-base-100 shadow-xl w-10/12">
                <div class="card-body">
                  <h2 class="card-title">
                    {{ $t("bank.transfer.immediateTransferAd.title") }}
                  </h2>
            ...
            <div class="flex flex-col items-center mt-10">
              <div class="card bg-primary shadow-xl w-10/12">
                <div class="card-body text-primary-content">
                  <h2 class="card-title">
                    {{ $t("bank.transfer.passkeysAd.title") }}
                  </h2>
                  <p class="text-justify">
